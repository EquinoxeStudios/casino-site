...
<head>
    ...
    <title>7's Deluxe Repeater - Jonsslots</title>
    <link rel="canonical" href="https://jonsslots.com/games/7s-deluxe-repeater" />
        ...
        <section class="game-header">
            <div class="game-header-content">
                <nav class="breadcrumb">
                    ...
                    <span class="breadcrumb-separator">/</span>
                    <span>7's Deluxe Repeater</span>
                </nav>
                
                <h1 class="game-title">7's Deluxe Repeater</h1>
            </div>
        </section>
            ...
            <div class="game-wrapper">
                <div class="game-iframe-container">
                    <div class="game-loading" id="gameLoading">
                        ...
                        <p>Loading 7's Deluxe Repeater...</p>
                    </div>
                    
                    <iframe 
                        id="gameIframe"
                        class="game-iframe" 
                        src="https://slotslaunch.com/iframe/9436?token=6neGxBm3O8L6Wy2ZbD0xykkFwtaDi653SH7RanMSLtEPDE1V5f"
                        title="7's Deluxe Repeater"
                        allowfullscreen
                        onload="hideLoading()"
                        onerror="showError()">
                    </iframe>
