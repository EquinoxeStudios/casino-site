...
<head>
    ...
    <title>100 Crown Hot - Jonsslots</title>
    <link rel="canonical" href="https://jonsslots.com/games/100-crown-hot" />
        ...
        <section class="game-header">
            <div class="game-header-content">
                <nav class="breadcrumb">
                    ...
                    <span class="breadcrumb-separator">/</span>
                    <span>100 Crown Hot</span>
                </nav>
                
                <h1 class="game-title">100 Crown Hot</h1>
            </div>
        </section>
            ...
            <div class="game-wrapper">
                <div class="game-iframe-container">
                    <div class="game-loading" id="gameLoading">
                        ...
                        <p>Loading 100 Crown Hot...</p>
                    </div>
                    
                    <iframe 
                        id="gameIframe"
                        class="game-iframe" 
                        src="https://slotslaunch.com/iframe/37044?token=6neGxBm3O8L6Wy2ZbD0xykkFwtaDi653SH7RanMSLtEPDE1V5f"
                        title="100 Crown Hot"
                        allowfullscreen
                        onload="hideLoading()"
                        onerror="showError()">
