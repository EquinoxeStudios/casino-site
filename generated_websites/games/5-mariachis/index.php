...
<head>
    ...
    <title>5 Mariachis - Jonsslots</title>
    <link rel="canonical" href="https://jonsslots.com/games/5-mariachis" />
    ...
    <main class="main-wrapper" id="mainWrapper">
        ...
        <section class="game-header">
            <div class="game-header-content">
                ...
                <h1 class="game-title">5 Mariachis</h1>
            </div>
        </section>
            ...
            <div class="game-wrapper">
                <div class="game-iframe-container">
                    <div class="game-loading" id="gameLoading">
                        ...
                        <p>Loading 5 Mariachis...</p>
                    </div>
                    
                    <iframe 
                        id="gameIframe"
                        class="game-iframe" 
                        src="https://slotslaunch.com/iframe/14073?token=6neGxBm3O8L6Wy2ZbD0xykkFwtaDi653SH7RanMSLtEPDE1V5f"
                        title="5 Mariachis"
                        allowfullscreen
                        onload="hideLoading()"
                        onerror="showError()">
