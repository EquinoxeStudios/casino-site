...
<head>
    ...
    <title>5 on the Farm - Jonsslots</title>
    <link rel="canonical" href="https://jonsslots.com/games/5-on-the-farm" />
        ...
        <section class="game-header">
            <div class="game-header-content">
                <nav class="breadcrumb">
                    ...
                    <span class="breadcrumb-separator">/</span>
                    <span>5 on the Farm</span>
                </nav>
                
                <h1 class="game-title">5 on the Farm</h1>
            </div>
        </section>
            ...
            <div class="game-wrapper">
                <div class="game-iframe-container">
                    <div class="game-loading" id="gameLoading">
                        ...
                        <p>Loading 5 on the Farm...</p>
                    </div>
                    
                    <iframe 
                        id="gameIframe"
                        class="game-iframe" 
                        src="https://slotslaunch.com/iframe/18818?token=6neGxBm3O8L6Wy2ZbD0xykkFwtaDi653SH7RanMSLtEPDE1V5f"
                        title="5 on the Farm"
                        allowfullscreen
                        onload="hideLoading()"
                        onerror="showError()">
