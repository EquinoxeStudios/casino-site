...
<head>
    ...
    <title>40 Cash Bells - Jonsslots</title>
    <link rel="canonical" href="https://jonsslots.com/games/40-cash-bells" />
        ...
        <section class="game-header">
            <div class="game-header-content">
                <nav class="breadcrumb">
                    ...
                    <span class="breadcrumb-separator">/</span>
                    <span>40 Cash Bells</span>
                </nav>
                
                <h1 class="game-title">40 Cash Bells</h1>
            </div>
        </section>
            ...
            <div class="game-wrapper">
                <div class="game-iframe-container">
                    <div class="game-loading" id="gameLoading">
                        ...
                        <p>Loading 40 Cash Bells...</p>
                    </div>
                    
                    <iframe 
                        id="gameIframe"
                        class="game-iframe" 
                        src="https://slotslaunch.com/iframe/1922?token=6neGxBm3O8L6Wy2ZbD0xykkFwtaDi653SH7RanMSLtEPDE1V5f"
                        title="40 Cash Bells"
                        allowfullscreen
                        onload="hideLoading()"
                        onerror="showError()">
