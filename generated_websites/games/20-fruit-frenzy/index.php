...
<head>
    ...
    <title>20 Fruit Frenzy - Jonsslots</title>
    <link rel="canonical" href="https://jonsslots.com/games/20-fruit-frenzy" />
        ...
        <section class="game-header">
            <div class="game-header-content">
                <nav class="breadcrumb">
                    ...
                    <span class="breadcrumb-separator">/</span>
                    <span>20 Fruit Frenzy</span>
                </nav>
                
                <h1 class="game-title">20 Fruit Frenzy</h1>
            </div>
        </section>
            ...
            <div class="game-wrapper">
                <div class="game-iframe-container">
                    <div class="game-loading" id="gameLoading">
                        ...
                        <p>Loading 20 Fruit Frenzy...</p>
                    </div>
                    
                    <iframe 
                        id="gameIframe"
                        class="game-iframe" 
                        src="https://slotslaunch.com/iframe/18757?token=6neGxBm3O8L6Wy2ZbD0xykkFwtaDi653SH7RanMSLtEPDE1V5f"
                        title="20 Fruit Frenzy"
                        allowfullscreen
                        onload="hideLoading()"
                        onerror="showError()">
                    </iframe>
